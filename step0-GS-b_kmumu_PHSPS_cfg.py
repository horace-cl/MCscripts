...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/fragment.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step0-GS-b_kmumu_PHSPS.root'),
...
process.oneBmeson = cms.EDFilter("OnlyOneParticleFilter",
    ParticleID = cms.untracked.int32(521)
)


process.mufilterPt6 = cms.EDFilter("PythiaFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.decayfilter+process.oneBmeson)
