...
CMSSW_BASE:=/afs/cern.ch/user/h/hcrottel/private/MCProdNoThreads/MCscripts/CMSSW_10_2_13_patch1
...
export CCACHE_BASEDIR:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw-patch/CMSSW_10_2_13_patch1
endif
...
CMSSW_BASE_FULL_RELEASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_2_13
CMSSW_BINDIR:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_2_13/bin/slc7_amd64_gcc700
...
LOCALTOP:=/afs/cern.ch/user/h/hcrottel/private/MCProdNoThreads/MCscripts/CMSSW_10_2_13_patch1
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/afs/cern.ch/user/h/hcrottel/private/MCProdNoThreads/MCscripts/CMSSW_10_2_13_patch1
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw-patch/CMSSW_10_2_13_patch1
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_10_2_13_patch1:slc7_amd64_gcc700:V2_2_9_pre10:SRT_
SCRAM_CONFIGCHKSUM:=V05-07-32
SCRAM_LOOKUPDB_WRITE:=/cvmfs/cms.cern.ch
SCRAM_CXX11_ABI:=1
SCRAM_PROJECTVERSION:=CMSSW_10_2_13_patch1
