...
oneBmeson = cms.EDFilter("OnlyOneParticleFilter",
    ParticleID = cms.untracked.int32(521),
)


mufilterPt6 = cms.EDFilter("PythiaFilter",  # bachelor muon with kinematic cuts.
...
ProductionFilterSequence = cms.Sequence(generator*decayfilter*oneBmeson)#*mufilterPt6)
